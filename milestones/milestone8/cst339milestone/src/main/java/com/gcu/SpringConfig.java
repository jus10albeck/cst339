...
public class SpringConfig 
{
	...
	public CollectionsBusinessInterface collectionsBusinessService(
	    ...
	    com.gcu.data.repository.WishlistRepository wishlistRepo,
	    com.gcu.security.CryptoService crypto
	) {
	    return new CollectionsBusinessService(
	        albumRepo, albumMovieRepo, directorRepo, ratingRepo, videoTypeRepo,
	        movieRepo, userRepo, movieListDao, crypto, wishlistRepo
	    );
	}
}