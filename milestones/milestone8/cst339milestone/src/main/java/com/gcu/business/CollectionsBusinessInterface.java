...
public interface CollectionsBusinessInterface 
{
	...
	void deleteAlbumFor(String username, Long albumId);
	Long getOrCreatePrimaryAlbumId(String username);
	

	List<WishlistRow> getWishlistFor(String username);
	void addToWishlist(String username, Long movieId);
	void moveWishlistItemToCollection(String username, Long movieId,
	                                  String format);
	void removeFromWishlist(String username, Long movieId);
	
	void createMovieAndAddToWishlist(String username, MovieModel movie);
}
