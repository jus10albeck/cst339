...
![encrypted usernames and passwords](images/encrypt.png)

- Screenshot of the Wishlist page and Wishlist add movie modal

![wishlist page](images/wishlist.png)

![add movie modal](images/wishlistModal.png)

### Sitemap

- Screenshot of the original Sitemap proposal

![add movie modal](images/collectionsSitemap.png)

![add movie modal](images/wishlistSitemap.png)
